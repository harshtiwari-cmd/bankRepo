...
public class BankBranchHarsh {
    ...
    public CoordinatesHarsh getCoordinates() {
        return coordinatesHarsh;
    }

    public void setCoordinates(CoordinatesHarsh coordinatesHarsh) {
        this.coordinatesHarsh = coordinatesHarsh;
    }
