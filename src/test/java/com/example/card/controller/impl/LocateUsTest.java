...
//        when(locateUsService.fetchBranches()).thenReturn(List.of(branchDto));
//        when(locateUsService.fetchAtms()).thenReturn(List.of(atmDto));
//        when(locateUsService.fetchKiosks()).thenReturn(List.of(kioskDto));
//
//        mockMvc.perform(
//                get("/locate-us")
...
//
//        when(locateUsService.fetchBranches()).thenThrow(new RuntimeException("DB error"));
//
