...
//
//        when(locateUsService.fetchByType("BRANCH", null)).thenReturn(List.of(branchDTO));
//        when(locateUsService.fetchByType("ATM", null)).thenReturn(List.of(atmDto));
//        when(locateUsService.fetchByType("KIOSK", null)).thenReturn(List.of(kioskDto));
//
//        mockMvc.perform(
//                post("/locate-us")
...
//        when(locateUsService.fetchByType("ATM", "")).thenReturn(Collections.emptyList());
...
//
//        when(locateUsService.fetchByType("ATM", "")).thenReturn(List.of(atmDto));
//        when(locateUsService.fetchByType("KIOSK", "")).thenReturn(Collections.emptyList());
...
//                .andExpect(jsonPath("$.data[2].kiosks[0].arabicName").value("Dukhan - Alsad"))
...
//        when(locateUsService.fetchByType("ATM", "")).thenReturn(Collections.emptyList());
//        when(locateUsService.fetchByType("KIOSK", "")).thenThrow(new RuntimeException("Database Error"));
//        when(locateUsService.fetchByType("BRANCH", "")).thenReturn(Collections.emptyList());
//
//
//        mockMvc.perform(post("/locate-us")
